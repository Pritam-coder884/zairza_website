 ...
 const pastEventData=[
  ...
  return (
    <div className="event__container">
      ...
      <div className="events_heading_box"><h1 className="events_heading">Upcoming Events</h1></div>
      <div className="event_card">
        {upcomingEventData.map((data,id)=>{
            return <Card data={data} key={id} width="360px" />
        })}
      </div>
      <div className="events_heading_box" style={{marginTop:"1rem"}}><h1 className="events_heading">Past Events</h1></div>
